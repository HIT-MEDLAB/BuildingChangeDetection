import { FaBookOpen, FaLightbulb, FaExclamationTriangle, FaHeadset, FaInfoCircle, FaUpload, FaPaperPlane, FaSpinner, FaChartBar } from "react-icons/fa";
import "./Help.css";
  ...
  return (
    <div className="help-page">
      ...
      <main className="help-content">
        ...
        <p className="help-subtitle">Find information and guidance to use the system effectively.</p>

        <section className="help-card wide-card">
          <div className="circle blue"><FaBookOpen /></div>
          <div>
        ...
        <div className="help-grid">
          <section className="help-card green-card">
            <div className="circle green"><FaLightbulb /></div>
            <div>
          ...
          <section className="help-card orange-card">
            <div className="circle orange"><FaExclamationTriangle /></div>
            <div>
              <h3 className="orange-text">3. Common Issues</h3>
              <p>● <b>Images are not similar:</b> Results may be inaccurate.</p>
              <p>● <b>Upload failed:</b> Try again with a supported file (JPG/PNG).</p>
              <p>● <b>No changes detected:</b> The system may not detect small differences.</p>
            </div>
          </section>
        </div>

        <section className="help-card purple-card">
          <div className="circle purple"><FaHeadset /></div>
          <div>
            <h3 className="purple-text">4. Contact Support</h3>
            <p>If you need further assistance or encounter any issues, please contact your system administrator.</p>
          </div>
        </section>

        <div className="info-box">
          <FaInfoCircle />
          <span>For more information about the system and its capabilities, please refer to the user manual or contact support.</span>
        </div>
      </main>
    </div>
  );
